  ...
  return (
    <div className="banner">
      <p className="banner-text">
        WedCapture Wedding Company — <strong>The Wedding Storyteller</strong>.
        Capturing love through cinematic wedding films and timeless photography.
        From planning to execution, we turn your big day into a beautiful story
